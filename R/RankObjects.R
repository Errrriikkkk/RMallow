...
.initFoo <- function(where = 'package:RMallow'){
  # "ranking" object.
  ...
  setClass("V", representation(V = "matrix"),
           prototype(numeric(0)), where = where)
  setClass("meaning", representation(meaning = "character"),
           prototype(character(0)))
  setClass("ranking", 
           contains = c("ranks", "info", "type", "ties",
                        "geqties", "relative", "V", 
                        "items", "rankers", "meaning"), where = where)
  ...
  setGeneric('meaning', function(object) standardGeneric('meaning'), where = where)
  setMethod('meaning', signature = 'ranking',
            function(object) {
              object@meaning
            }, where = where)
  ...
  setMethod(f = "initialize",
            signature = "ranking",
            function(.Object, ranks, meaning = NULL) {
              browser()
              cat('missing')
              if(!missing(ranks)) {
                cat('not missing')
